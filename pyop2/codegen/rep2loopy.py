...
class INVCallable(LACallable):
    ...
    def generate_preambles(self, target):
        ...
        inverse_preamble = """
            ...
            static void inverse(PetscScalar* __restrict__ Aout, const PetscScalar* __restrict__ A, const PetscBLASInt N)
            {
                PetscBLASInt info;
...
class SolveCallable(LACallable):
    ...
    def generate_preambles(self, target):
        ...
        code = """
            ...
            static PetscBLASInt ipiv_buffer[BUF_SIZE];
            static void solve(PetscScalar* __restrict__ out, const PetscScalar* __restrict__ A, PetscScalar* __restrict__ B, PetscBLASInt N)
            {
                PetscBLASInt info;
                PetscBLASInt *ipiv = N <= BUF_SIZE ? ipiv_buffer : malloc(N*sizeof(*ipiv));
